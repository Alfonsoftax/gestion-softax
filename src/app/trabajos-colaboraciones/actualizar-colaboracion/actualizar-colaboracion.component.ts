...
@Component({
  selector: 'app-actualizar-colaboracion',
  templateUrl: './actualizar-colaboracion.component.html',
  styleUrls: ['./actualizar-colaboracion.component.css']
})
export class ActualizarColaboracionComponent implements OnInit {
